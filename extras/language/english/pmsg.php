...
define("_PM_SORRY","Sorry! You must be a registered user to send a message.");
define("_PM_REGISTERNOW","Register Now!");
define("_PM_GOBACK","Go Back");
define("_PM_USERNOEXIST","That account doesn't exist.");
define("_PM_PLZTRYAGAIN","Please check the name and try again.");
define("_PM_MESSAGEPOSTED","Your message has been sent");
define("_PM_CLICKHERE","View your private messages");
define("_PM_ORCLOSEWINDOW","Close window.");
define("_PM_USERWROTE","%s wrote:");
define("_PM_TO","To: ");
define("_PM_SUBJECTC","Subject: ");
define("_PM_MESSAGEC","Message: ");
define("_PM_CLEAR","Clear");
define("_PM_CANCELSEND","Cancel");
...
define("_PM_PLZREG","Please register or login to send private messages!");
