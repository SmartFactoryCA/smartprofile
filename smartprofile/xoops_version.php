<?php
// $Id: xoops_version.php,v 1.11 2007/06/10 19:22:48 mithyt2 Exp $
//  ------------------------------------------------------------------------ //
...
$modversion['author'] = "Jan Pedersen (mod by Mark Boyden)";
...
$modversion['config'][6]['default'] = "webmaster|^thenoise|^noise|^admin";
...
// Templates
$modversion['templates'][1]['file'] = 'smartprofile_admin_fieldlist.html';
$modversion['templates'][1]['description'] = '';

$modversion['templates'][2]['file'] = 'smartprofile_userinfo.html';
$modversion['templates'][2]['description'] = '';

$modversion['templates'][3]['file'] = 'smartprofile_admin_categorylist.html';
$modversion['templates'][3]['description'] = '';

$modversion['templates'][4]['file'] = 'smartprofile_search.html';
$modversion['templates'][4]['description'] = '';

$modversion['templates'][5]['file'] = 'smartprofile_results.html';
$modversion['templates'][5]['description'] = '';

$modversion['templates'][6]['file'] = 'smartprofile_admin_visibility.html';
$modversion['templates'][6]['description'] = '';

$modversion['templates'][7]['file'] = 'smartprofile_admin_steplist.html';
$modversion['templates'][7]['description'] = '';

$modversion['templates'][8]['file'] = 'smartprofile_register.html';
