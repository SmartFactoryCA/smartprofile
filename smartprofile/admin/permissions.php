<?php
// $Id: permissions.php,v 1.3 2006/12/13 15:43:18 mithyt2 Exp $
//  ------------------------------------------------------------------------ //
...
// ------------------------------------------------------------------------- //
//  SmartProfile v1.03-MB01 2008-06-06 | Mark Boyden (mark.boyden@noise.org) //
//  Modified SmartProfile v1.03 CVS 2007-06-13                               //
//  (search MB for changes)                                                  //
//  ------------------------------------------------------------------------ //
//  moved switch($op) call so visibility header redirect works
//  ------------------------------------------------------------------------ //
include 'header.php';
