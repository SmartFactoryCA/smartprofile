CREATE TABLE `smartprofile_category` (
...
CREATE TABLE `smartprofile_field` (
...
CREATE TABLE `smartprofile_visibility` (
...
CREATE TABLE `smartprofile_regstep` (
...
CREATE TABLE `smartprofile_profile` (
