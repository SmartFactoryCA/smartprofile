...
define("_PROFILE_AM_CNRNU","ناتواني در رجيستر کردن کاربر جديد");
define("_PROFILE_AM_EDEUSER","ويرايش/حذف کاربران");
define("_PROFILE_AM_NICKNAME","نام خودماني");
...
define("_PROFILE_AM_CNUUSER","ناتواني در بروزرساني عضو");
...
define("_PROFILE_AM_CANNOTDELETESELF", "حذف عضويتتون امکان پذير نيست- براي حذف عضوييتتون از صفحه پروفايل استفاده کنيد");
