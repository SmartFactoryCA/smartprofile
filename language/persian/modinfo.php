...
define("_PROFILE_MI_MAX_UNAME", "حد اکثر کارکتر مجاز برای شناسه کاربری");
define("_PROFILE_MI_MAX_UNAME_DESC", "");
define("_PROFILE_MI_MIN_UNAME", "حد اقل کارکتر مجاز برای شناسه کاربری");
...
define("_PROFILE_MI_MINPASS", "حد اقل مقدار کاراکتر مجاز برای واژه رمز");
...
define("_PROFILE_MI_ADMINACTV","فعال شدن به وسيله مديان");
...
define("_PROFILE_MI_LIGHT","سبک(قابل استفاده براي زبان هاي دوبايت مثل فارسي");
...
define("_PROFILE_MI_AVATARWIDTH", "بیشترین عرض مجاز avatar (pixel).");
define("_PROFILE_MI_AVATARWIDTH_DESC", "");
define("_PROFILE_MI_AVATARHEIGHT", "بیشترین طول مجاز avatar (pixel).");
define("_PROFILE_MI_AVATARHEIGHT_DESC", "");
define("_PROFILE_MI_AVATARMAX", "بیشترین حجم مجاز avatar (byte).");
...
define("_PROFILE_MI_AVATARMINPOSTS_DESC", "حد اقل پست مورد نیاز که عضو را مجاز به بارگذاری تصویر (avatar) میکند را وارد کنید");
